...
public class RulesOf6005 {
	...
	public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
	    ...
	    // If the code is written by yourself, it can always be used.
	    if (writtenByYourself) {
	        return true;
	    }
	    
	    // Code not written by you
	    if (citingYourSource && availableToOthers) {
	    	
	    	 if (!writtenAsCourseWork) {
	    		 
	 	        if (!implementationRequired) {
	 	        	
	 	            return true; // Proper citation is required
	 	        }
	...
	public static void main(String[] args) {
	    System.out.println("You may certainly use code you wrote yourself: " +
	        RulesOf6005.mayUseCodeInAssignment(true, false, true, true, true)); // true
	    System.out.println("Code available to others" +
	        RulesOf6005.mayUseCodeInAssignment(false, true, false, true, false)); // true
	    System.out.println("Code not available to others: " +
	        RulesOf6005.mayUseCodeInAssignment(false, false, false, true, false)); // false
	    System.out.println("Coursework with proper citation: " +
	        RulesOf6005.mayUseCodeInAssignment(false, true, true, true, false)); // true
	    System.out.println("Coursework without proper citation: " +
	        RulesOf6005.mayUseCodeInAssignment(false, true, true, false, false)); // false
	    System.out.println("Implementation required" +
	        RulesOf6005.mayUseCodeInAssignment(false, true, false, true, true)); // false
	    System.out.println("Coursework, not available to others: " +
	        RulesOf6005.mayUseCodeInAssignment(false, false, true, true, false)); // false
	    System.out.println("Coursework, properly cited, implementation required: " +
	        RulesOf6005.mayUseCodeInAssignment(false, true, true, true, true)); // false
	    System.out.println("Coursework, properly cited, not implementation required: " +
	        RulesOf6005.mayUseCodeInAssignment(false, true, true, true, false)); // true
	}
